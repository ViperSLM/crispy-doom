...
state_t	states[NUMSTATES] = {
    ...
    {SPR_VILE,25,7,{VSLM_SpawnFire},S_VILE_RAISE2,0,0},		// S_VILE_RAISE1
    {SPR_VILE,24,7,{VSLM_SpawnFire},S_VILE_RAISE3,0,0},		// S_VILE_RAISE2
    {SPR_VILE,23,7,{VSLM_SpawnFire},S_VILE_RAISE4,0,0},		// S_VILE_RAISE3
    {SPR_VILE,22,7,{VSLM_SpawnFire},S_VILE_RAISE5,0,0},		// S_VILE_RAISE4
    {SPR_VILE,21,7,{VSLM_SpawnFire},S_VILE_RAISE6,0,0},		// S_VILE_RAISE5
    {SPR_VILE,20,7,{VSLM_SpawnFire},S_VILE_RAISE7,0,0},		// S_VILE_RAISE6
    {SPR_VILE,19,7,{VSLM_SpawnFire},S_VILE_RAISE8,0,0},		// S_VILE_RAISE7
    {SPR_VILE,18,7,{VSLM_SpawnFire},S_VILE_RAISE9,0,0},		// S_VILE_RAISE8
    {SPR_VILE,17,7,{VSLM_SpawnFire},S_VILE_RAISE10,0,0},	// S_VILE_RAISE9
	{SPR_VILE,16,7,{VSLM_SpawnFire},S_VILE_RUN1,0,0},		// S_VILE_RAISE10
    ...
    {SPR_TROO,20,5,{VSLM_SpawnFire},S_TROO_XRAISE2,0,0},	// S_TROO_XRAISE1
    {SPR_TROO,19,5,{VSLM_SpawnFire},S_TROO_XRAISE3,0,0},	// S_TROO_XRAISE2
    {SPR_TROO,18,5,{VSLM_SpawnFire},S_TROO_XRAISE4,0,0},	// S_TROO_XRAISE3
    {SPR_TROO,17,5,{VSLM_SpawnFire},S_TROO_XRAISE5,0,0},	// S_TROO_XRAISE4
    {SPR_TROO,16,5,{VSLM_SpawnFire},S_TROO_XRAISE6,0,0},	// S_TROO_XRAISE5
    {SPR_TROO,15,5,{VSLM_SpawnFire},S_TROO_XRAISE7,0,0},	// S_TROO_XRAISE6
    {SPR_TROO,14,5,{VSLM_SpawnFire},S_TROO_XRAISE8,0,0},	// S_TROO_XRAISE7
	{SPR_TROO,13,5,{VSLM_SpawnFire},S_TROO_RUN1,0,0},		// S_TROO_XRAISE8
    ...
    {SPR_SPID,18,10,{VSLM_SpawnFire},S_SPID_RAISE2,0,0},	// S_SPID_RAISE1
    {SPR_SPID,18,10,{VSLM_SpawnFire},S_SPID_RAISE3,0,0},	// S_SPID_RAISE2
    {SPR_SPID,17,10,{VSLM_SpawnFire},S_SPID_RAISE4,0,0},	// S_SPID_RAISE3
    {SPR_SPID,16,10,{VSLM_SpawnFire},S_SPID_RAISE5,0,0},	// S_SPID_RAISE4
    {SPR_SPID,15,10,{VSLM_SpawnFire},S_SPID_RAISE6,0,0},	// S_SPID_RAISE5
    {SPR_SPID,14,10,{VSLM_SpawnFire},S_SPID_RAISE7,0,0},	// S_SPID_RAISE6
    {SPR_SPID,13,10,{VSLM_SpawnFire},S_SPID_RAISE8,0,0},	// S_SPID_RAISE7
    {SPR_SPID,12,10,{VSLM_SpawnFire},S_SPID_RAISE9,0,0},	// S_SPID_RAISE8
    {SPR_SPID,11,10,{VSLM_SpawnFire},S_SPID_RAISE10,0,0},	// S_SPID_RAISE9
    {SPR_SPID,10,10,{VSLM_SpawnFire},S_SPID_RAISE11,0,0},	// S_SPID_RAISE10
	{SPR_SPID,9,10,{VSLM_SpawnFire},S_SPID_RUN1,0,0},	// S_SPID_RAISE11
    ...
    {SPR_CYBR,15,10,{VSLM_SpawnFire},S_CYBER_RAISE2,0,0},	// S_CYBER_RAISE1
    {SPR_CYBR,15,10,{VSLM_SpawnFire},S_CYBER_RAISE3,0,0},	// S_CYBER_RAISE2
    {SPR_CYBR,14,10,{VSLM_SpawnFire},S_CYBER_RAISE4,0,0},	// S_CYBER_RAISE3
    {SPR_CYBR,13,10,{VSLM_SpawnFire},S_CYBER_RAISE5,0,0},	// S_CYBER_RAISE4
    {SPR_CYBR,12,10,{VSLM_SpawnFire},S_CYBER_RAISE6,0,0},	// S_CYBER_RAISE5
    {SPR_CYBR,11,10,{VSLM_SpawnFire},S_CYBER_RAISE7,0,0},	// S_CYBER_RAISE6
    {SPR_CYBR,10,10,{VSLM_SpawnFire},S_CYBER_RAISE8,0,0},	// S_CYBER_RAISE7
    {SPR_CYBR,9,10,{VSLM_SpawnFire},S_CYBER_RAISE9,0,0},	// S_CYBER_RAISE8
    {SPR_CYBR,8,10,{VSLM_SpawnFire},S_CYBER_RAISE10,0,0},	// S_CYBER_RAISE9
	{SPR_CYBR,7,10,{VSLM_SpawnFire},S_CYBER_RUN1,0,0},		// S_CYBER_RAISE10
    ...
    {SPR_SSWV,21,5,{VSLM_SpawnFire},S_SSWV_XRAISE2,0,0},	// S_SSWV_XRAISE1
    {SPR_SSWV,20,5,{VSLM_SpawnFire},S_SSWV_XRAISE3,0,0},	// S_SSWV_XRAISE2
    {SPR_SSWV,19,5,{VSLM_SpawnFire},S_SSWV_XRAISE4,0,0},	// S_SSWV_XRAISE3
    {SPR_SSWV,17,5,{VSLM_SpawnFire},S_SSWV_XRAISE6,0,0},	// S_SSWV_XRAISE5
    {SPR_SSWV,16,5,{VSLM_SpawnFire},S_SSWV_XRAISE7,0,0},	// S_SSWV_XRAISE6
    {SPR_SSWV,18,5,{VSLM_SpawnFire},S_SSWV_XRAISE5,0,0},	// S_SSWV_XRAISE4
    {SPR_SSWV,15,5,{VSLM_SpawnFire},S_SSWV_XRAISE8,0,0},	// S_SSWV_XRAISE7
    {SPR_SSWV,14,5,{VSLM_SpawnFire},S_SSWV_XRAISE9,0,0},	// S_SSWV_XRAISE8
	{SPR_SSWV,13,5,{VSLM_SpawnFire},S_SSWV_RUN1,0,0},		// S_SSWV_XRAISE9
